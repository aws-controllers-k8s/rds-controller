...
const (
	finalizerString = "finalizers.rds.services.k8s.aws/DBSnapshot"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("dbsnapshots")
